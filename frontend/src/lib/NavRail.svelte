...
<nav class="w-[52px] bg-surface-sunken border-r border-border flex flex-col items-center py-3 gap-1 shrink-0 relative texture-noise">
  ...
  <button
    class="w-9 h-9 rounded-lg flex items-center justify-center transition-all
      {isActive('chat') ? 'bg-accent-soft text-accent' : 'text-text-tertiary hover:text-text-secondary hover:bg-surface-raised'}"
  ...
  <button
    class="w-9 h-9 rounded-lg flex items-center justify-center transition-all
      {isActive('settings') ? 'bg-accent-soft text-accent' : 'text-text-tertiary hover:text-text-secondary hover:bg-surface-raised'}"
